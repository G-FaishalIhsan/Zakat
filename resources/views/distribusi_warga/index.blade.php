...
@section('title', 'Distribusi Zakat Fitrah Warga')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('distribusi-warga.create') }}" class="btn btn-primary">Tambah Distribusi</a>
            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('distribusi-warga.edit', $distribusi->id) }}">
                                                <i class="icon-base bx bx-edit-alt me-1 text-dark"></i> Edit
                                            </a>
                                            <form action="{{ route('distribusi-warga.destroy', $distribusi->id) }}"
