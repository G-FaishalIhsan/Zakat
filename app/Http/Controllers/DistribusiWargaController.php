...
class DistribusiWargaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('distribusi_warga.index', compact('distribusiList'));
    }
    ...
    public function create()
    {
        ...
        return view('distribusi_warga.create', compact('mustahikList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $mustahik = mustahik::where('nama_mustahik', $request->nama_mustahik)->first();
    ...
    public function edit($id)
    {
        ...
        return view('distribusi_warga.edit', compact('distribusi', 'mustahikList'));
    }
